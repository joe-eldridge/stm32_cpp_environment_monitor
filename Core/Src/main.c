...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, eInk_CS_Pin|SD_CS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LD2_Pin eInk_CS_Pin SD_CS_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|eInk_CS_Pin|SD_CS_Pin;
  ...
  /*Configure GPIO pins : eInk_D_C_Pin eInk_RST_Pin */
  GPIO_InitStruct.Pin = eInk_D_C_Pin|eInk_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
